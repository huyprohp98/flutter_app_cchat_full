...
//
// class WidgetProductFilterTwo extends StatelessWidget {
...
//     return BlocBuilder<HomeDataFullBloc, HomeDataFullState>
//       (builder: (context, state) {
//       if (state is HomeDataFullLoaded) {
//         return Container(
...
//                           height: 25,
//                         ),
//                         _buildColor(context, state.homeResponse.data.color),
//                         WidgetSpacer(
//                           height: 25,
//                         ),
//                         _buildSize(context, state.homeResponse.data.size)
//                       ],
//                     ),
//                   ),
//                 ),
...
//           ),
//         );
//       } else if (state is HomeDataFullLoading) {
//         return Center(
//           child: WidgetCircleProgress(),
//         );
//       } else if (state is HomeDataFullNotLoaded) {
...
//   }
//
//   Widget _buildColor(BuildContext context, List<ColorCatergoryProductHot> colors) {
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         Text(
...
//   }
//
//   Widget _buildPrice(BuildContext context, HomeDataFullState state) {
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         Text(
