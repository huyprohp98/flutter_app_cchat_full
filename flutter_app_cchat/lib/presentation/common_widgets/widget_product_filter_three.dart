...
class WidgetProductFilterThree extends StatelessWidget {
  final double priceBegin;
  final double priceEnd;
  final AttrColor color;
  final AttrSize size;
  final ValueChanged<RangeValues> onSliderChange;
  final ValueChanged<AttrColor> onColorTap;
  final ValueChanged<AttrSize> onSizeTap;
  final Function onCompleteTap;

  const WidgetProductFilterThree(
      {Key key,
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HomeDataBloc, HomeDataState>(builder: (context, state) {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildColor(context, state.homeResponse.data.colors),
                        WidgetSpacer(
                          height: 25,
                        ),
                        _buildSize(context, state.homeResponse.data.sizes)
                      ],
                    ),
                  ),
                ),
  ...
  Widget _buildSize(BuildContext context, List<AttrSize> sizes) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  Widget _buildColor(BuildContext context, List<AttrColor> colors) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  Widget _buildPrice(BuildContext context, HomeDataState state) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
